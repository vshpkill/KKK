...
//    private ImageView mRefreshView;
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        refreshHeadView = LayoutInflater.from(context).inflate(R.layout.refreshheadview, null);
//        mRefreshView = new ImageView(context);

//        setRefreshStyle(type);

        addView(refreshHeadView);
...
//        mRefreshView.setPadding(left, top, right, bottom);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        refreshHeadView.measure(widthMeasureSpec, heightMeasureSpec);
    }
...
//                mBaseRefreshView.setPercent(mCurrentDragPercent, true);
    ...
    private void animateOffsetToStartPosition() {
        ...
        refreshHeadView.clearAnimation();
        refreshHeadView.startAnimation(mAnimateToStartPosition);
    }
    ...
    private void animateOffsetToCorrectPosition() {
        ...
        refreshHeadView.clearAnimation();
        refreshHeadView.startAnimation(mAnimateToCorrectPosition);
...
//        mBaseRefreshView.offsetTopAndBottom(offset);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        refreshHeadView.layout(left, top, left + width - right, top + height - bottom);
    }
